<script setup>
    ...
    import {ref} from 'vue'
    import { articleAddService, articleCategoryListService,articleDeleteService } from '@/api/article'
    ...
    const updateArticle = async (state) => {
        ...
        let result = await articleUpdateService(articleModel.value,articleId);
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>文章管理</span>
                <div class="extra">
                    <el-button type="primary" @click="articleTitle='添加文章';visibleDrawer = true;">添加文章</el-button>
                </div>
            </div>
        ...
        <el-form inline>
            <el-form-item label="文章分类：">
                <el-select placeholder="请选择" v-model="categoryId" style="min-width: 120px;">
                    <el-option 
            ...
            <el-form-item label="发布状态">
                <el-select placeholder="请选择" v-model="state" style="min-width: 120px;">
